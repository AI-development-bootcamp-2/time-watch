...
function authCookie(userId, role = 'employee') {
  return `token=${jwt.sign({ id: userId, role }, process.env.JWT_SECRET)}`
}
...
let owner  // regular employee
let admin  // admin user
let other  // another employee (used for ownership tests)
