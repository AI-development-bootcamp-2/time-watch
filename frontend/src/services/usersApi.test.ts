...
describe('createUser', () => {
  it('calls POST /api/users with the provided data', async () => {
    ...
    mockRequest.mockResolvedValue({ id: '2', ...data, is_active: true })
...
describe('updateUser', () => {
  it('calls PUT /api/users/:id with the correct URL', async () => {
    ...
    mockRequest.mockResolvedValue({ id: 'abc', ...data })
  ...
  it('propagates errors from request', async () => {
    mockRequest.mockRejectedValue({ status: 400 })
...
describe('deactivateUser', () => {
  it('calls PATCH /api/users/:id/deactivate', async () => {
    mockRequest.mockResolvedValue({ is_active: false })
